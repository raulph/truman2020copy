...
exports.getScript = (req, res, next) => {
  ...
  //req.user.createdAt
  var six_days = 86400000*6;
  var time_now = Date.now();
  var time_diff = time_now - req.user.createdAt;
  var beginning = req.user.createdAt;
  time_diff = time_diff + six_days;
  //var today = moment();
  //var tomorrow = moment(today).add(1, 'days');
  var two_days = (86400000 * 2); //two days in milliseconds
  var time_limit = time_diff - six_days; 
 // var time_limit = time_limit - six_days;

  //let time_now = moment()
  //var min = req.user.createdAt - t  s;
