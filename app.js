...
app.get('/feed/:minPostID', function(req,res) {
  res.send("minPostID is set to " + req.params.minPostID);
});

app.get('/feed/', function(req, res){
  res.send("minPostID is set to " + req.query.minPostID);
});

app.get('/feed/:maxPostID', function(req,res) {
  res.send("maxPostID is set to " + req.params.maxPostID);
});

app.get('/feed/', function(req, res){
  res.send("maxPostID is set to " + req.query.maxPostID);
});
